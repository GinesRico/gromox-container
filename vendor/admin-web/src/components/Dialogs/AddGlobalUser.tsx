...
const AddGlobalUser = (props: AddGlobalUserProps) => {
  ...
  const handleAdd = (e: React.MouseEvent) => {
    e.preventDefault();
    const { username, password, properties, domain, status, homeserver, chat, lang, noMaildir } = state;
  ...
  const { username, loading, properties, password, repeatPw,
    domain, status, homeserver, lang, chat, chatAvailable, noMaildir } = state;
    ...
    >
      ...
      <DialogContent>
        <FormControl className={classes.form}>
          ...
          {!noMaildir && <MagnitudeAutocomplete<Server>
            value={homeserver}
